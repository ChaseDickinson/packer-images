# Generated by Powerlevel10k configuration wizard on 2020-04-26 at 10:55 CDT.
...
# 24h time, slanted separators, slanted heads, slanted tails, 1 line, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    dir_writable            # current user permissions in dir
    vcs                     # git status
